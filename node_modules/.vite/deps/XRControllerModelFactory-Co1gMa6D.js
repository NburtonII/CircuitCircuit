import { Ni as Object3D, Po as SphereGeometry, Xr as Mesh, Zr as MeshBasicMaterial } from "./three.core-wVQK10Or.js";
import { t as GLTFLoader } from "./GLTFLoader-B5YYCsaq.js";
	...
	Object.values(motionController.components).forEach((component) => {
		...
		if (type === Constants.ComponentType.TOUCHPAD) {
			...
			if (component.touchPointNode) {
				const sphere = new Mesh(new SphereGeometry(.001), new MeshBasicMaterial({ color: 255 }));
...
//#endregion
export { XRControllerModelFactory as t };

//# sourceMappingURL=XRControllerModelFactory-Co1gMa6D.js.map