...
import { XRControllerModelFactory } from 'https://cdn.jsdelivr.net/npm/three@0.185.0/examples/jsm/webxr/XRControllerModelFactory.js';

import { OculusHandModel } from 'https://cdn.jsdelivr.net/npm/three@0.185.0/examples/jsm/webxr/OculusHandModel.js';
...
updateButtonLabels(){
    ...
    async loadModel(){
        ...
        let model
        try{
        model = await loader.loadAsync("https://cdn.jsdelivr.net/gh/NburtonII/CircuitCircuit@latest/Models/RacerCar.glb");
        } catch (error){
